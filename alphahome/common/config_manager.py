...
class ConfigManager:
    ...
    def load_config(self) -> Dict[str, Any]:
        ...
        if os.path.exists(self.config_file):
            try:
                ...
                logger.warning(f"读取配置文件 {self.config_file} 失败: {e}，使用环境变量或默认值")
        else:
    ...
    def _migrate_old_config(self):
        ...
        try:
            ...
            # 检查是否需要迁移
            if os.path.exists(old_config_file_path) and not os.path.exists(self.config_file):
    ...
    def get_task_config(self, task_name: str, key: Optional[str] = None, default: Any = None) -> Any:
        """获取任务特定配置
    ...
    def get_backtesting_config(self, key: Optional[str] = None, default: Any = None) -> Any:
        """获取回测模块配置
...
def get_task_config(task_name: str, key: Optional[str] = None, default: Any = None) -> Any:
    """获取任务特定配置"""
