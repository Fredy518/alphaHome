...
class MaterializedViewSQL:
    ...
    **Validates: Requirements 5.1, 5.2, 5.3**
    ...
    def pit_template(
        ...
        ...     view_name="pit_financial_indicators_mv",
        ...     source_table="rawdata.pit_financial_indicators",
        ...     key_columns=["ts_code"],
        ...     time_columns={"ann_date": "announcement_date", "end_date": "data_date"},
        ...     value_columns=["pe_ttm", "pb"],
        ...     quality_checks={"null_check": {"columns": ["pe_ttm", "pb"]}}
        ... )
    ...
    def aggregation_template(
        ...
        ...     view_name="sector_aggregation_mv",
        ...     source_table="rawdata.stock_daily",
    ...
    def join_template(
        ...
        ...     view_name="stock_with_industry_mv",
        ...     source_tables=["rawdata.stock_daily", "rawdata.industry_classification"],
        ...     join_conditions=["t1.ts_code = t2.ts_code"],
        ...     select_columns=["t1.ts_code", "t1.trade_date", "t1.close", "t2.industry"]
        ... )
        ...
        **Validates: Requirements 5.1, 5.3**
        ...
        # 血缘元数据
        select_parts.append(f"    '{', '.join(source_tables)}' as _source_tables")
        select_parts.append(f"    NOW() as _processed_at")
        select_parts.append(f"    CURRENT_DATE as _data_version")
