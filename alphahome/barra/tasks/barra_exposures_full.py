...
@task_register()
class BarraExposuresFullTask(BaseTask):
    ...
    async def _fetch_data(self, stop_event=None, **kwargs) -> Optional[Dict[str, Any]]:
    ...
    async def _save_data(self, data: pd.DataFrame, stop_event=None, **kwargs) -> Dict[str, Any]:
        ...
        # Complete industry one-hot encoding
