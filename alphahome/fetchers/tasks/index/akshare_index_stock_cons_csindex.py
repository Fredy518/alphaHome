...
@task_register()
class AkShareIndexStockConsCsindexTask(AkShareTask):
    domain = "index"
    name = "akshare_index_stock_cons_csindex"
    description = "中证指数-成分股目录（AkShare index_stock_cons_csindex）"
    table_name = "index_stock_cons_csindex"
    data_source = "akshare"
    ...
    indexes = [
        {"name": "idx_index_stock_cons_csindex_idx", "columns": "index_code"},
        {"name": "idx_index_stock_cons_csindex_const", "columns": "const_code"},
        {"name": "idx_index_stock_cons_csindex_date", "columns": "as_of_date"},
        {"name": "idx_index_stock_cons_csindex_update_time", "columns": "update_time"},
    ]
...
__all__ = ["AkShareIndexStockConsCsindexTask"]
