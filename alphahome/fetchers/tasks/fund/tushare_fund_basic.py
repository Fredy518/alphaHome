...
class TushareFundBasicTask(TushareTask):
    ...
    schema_def = {
        ...
        "issue_amount": {"type": "NUMERIC(20,3)"},
        "m_fee": {"type": "NUMERIC(8,6)"},
        "c_fee": {"type": "NUMERIC(8,6)"},
        "duration_year": {"type": "NUMERIC(8,4)"},
        "p_value": {"type": "NUMERIC(15,4)"},
        "min_amount": {"type": "NUMERIC(15,2)"},
        "exp_return": {"type": "NUMERIC(10,6)"},
