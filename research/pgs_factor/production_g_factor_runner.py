#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Research-side G factor runner compatibility entrypoint."""
...
def create_argument_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="生产级G因子计算运维脚本")
    ...
    parser.add_argument("--validate-express-forecast-ratio", action="store_true", help="验证Express/Forecast数据利用率")
    return parser
...
def main() -> int:
    ...
    return run_range(
        ...
        validate_express_forecast_ratio=args.validate_express_forecast_ratio,
    )
