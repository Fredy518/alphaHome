...
使用方法：
python scripts/production/factor_calculators/g_factor/calculate_g_factor_for_specific_dates.py --dates 2024-12-13 2024-12-20
"""
...
class SpecificDateGFactorCalculator:
    ...
    def __init__(self):
        self.calculator = ProductionGFactorCalculator()
