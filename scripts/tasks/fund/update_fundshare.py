...
"""
执行 Tushare 基金规模数据 (fund_share) 更新任务。
支持增量更新。
"""
...
TARGET_TASK_NAME = "tushare_fund_share"

class FundShareUpdater(TaskUpdaterBase):
    """
    基金规模数据更新工具
    """
    def __init__(self):
