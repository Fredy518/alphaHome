...
欢迎来到 AlphaHome 智能量化投研系统的文档中心！本目录包含了系统的完整文档，按功能模块分类组织。
...
- [数据处理模块深度解析](./architecture/processors_deep_dive.md) - Processor模块的三层架构与开发指南
...
### **🔧 工具文档**
- [命令行工具](./tools/cli.md) - Make命令和脚本使用
...
| 2025-01-XX | 1.4 | 完善TDD实践指南 | System |
| 2025-01-XX | 1.3 | 更新架构设计文档 | System |
